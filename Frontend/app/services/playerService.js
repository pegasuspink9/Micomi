...
export const playerService = {
  ...
  transformPlayerData: (apiData) => {
    ...
    return {
      ...
      playerRankName: apiData.player_rank_name || null,
      playerRankImage: apiData.player_rank_image || null,
      playerRankProgress: {
        playerCurrentPoints: apiData.player_rank_progress?.player_current_points || 0,
        playerRequiredPoints: apiData.player_rank_progress?.player_required_points || 0,
        playerNextRankName: apiData.player_rank_progress?.player_next_rank_name || null,
