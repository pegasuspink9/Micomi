...
import ElectricAbsolute from '../Components/Actual Game/Screen Play/components/AnimationsMain/Electric/Eletric';
  ...
  return (
    <>
      ...
      >
        ...
        <ElectricAbsolute
          top={20}            // or bottom, left, right — any absolute props
          right={18}
          width={88}
          height={88}
          zIndex={2000}
          ...
          visible={true}
          onPress={() => {
            console.log('Electric overlay pressed');
            // trigger a UI action: open modal, play sound, etc.
          }}
        />
